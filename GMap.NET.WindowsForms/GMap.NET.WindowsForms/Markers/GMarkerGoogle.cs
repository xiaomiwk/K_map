...
namespace GMap.NET.WindowsForms.Markers
{
    ...
    public class GMarkerGoogle : GMapMarker, ISerializable, IDeserializationCallback
    {
        ...
        /// <summary>
        /// marker using manual Image, NonSerialized
        /// </summary>
        /// <param name="p"></param>
        /// <param name="Image"></param>
        public GMarkerGoogle(PointLatLng p, Image Image)
            : base(p)
        {
            this.Image = Image;
            Size = new System.Drawing.Size(Image.Width, Image.Height);
        ...
        internal static Image GetIcon(string name)
        {
            ...
            {
                ret = Resources.ResourceManager.GetObject(name, Resources.Culture) as Image;
        ...
        public override void OnRender(Graphics g)
        {
            //if(!Bearing.HasValue)
            {
                if (ImageShadow != null)
                {
                    g.DrawImage(ImageShadow, LocalPosition.X, LocalPosition.Y, ImageShadow.Width, ImageShadow.Height);
                }
            }
        ...
        public override void Dispose()
        {
            if (Image != null)
            {
                if (!iconCache.ContainsValue(Image))
                {
                    Image.Dispose();
                    Image = null;
                }
