...
namespace GMap.NET.MapProviders
{
    ...
    public abstract class GoogleMapProviderBase : GMapProvider//, RoutingProvider, GeocodingProvider, DirectionsProvider
    {
        ...
        public bool TryCorrectVersion = false;
        ...
        public override void OnInitialized()
        {
            if (!init && TryCorrectVersion)
            {
                ...
                try
                {
                    string html = GetContentUsingHttp(url);
        ...
        public void GetSecureWords(GPoint pos, out string sec1, out string sec2)
        {
        ...
        //    try
        //    {
        //        string reverse = GetContentUsingHttp(url);
        ...
        //    try
        //    {
        //        string kml = GetContentUsingHttp(url);
