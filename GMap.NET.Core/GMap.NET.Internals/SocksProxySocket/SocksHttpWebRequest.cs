...
namespace GMap.NET.publics
{
    ...
    public class SocksHttpWebRequest : WebRequest
    {
        ...
        // darn MS for making everything public (yeah, I'm talking about you, System.net.KnownHttpVerb)
        ...
        private SocksHttpWebResponse publicGetResponse()
        {
