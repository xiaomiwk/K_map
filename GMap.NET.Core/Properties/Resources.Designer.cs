...
namespace GMap.NET.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 CREATE TABLE IF NOT EXISTS Tiles (X INTEGER NOT NULL, Y INTEGER NOT NULL, Zoom INTEGER NOT NULL, Tile BLOB NULL);
        ///CREATE INDEX IF NOT EXISTS IndexOfTiles ON Tiles (X, Y, Zoom);
        /// 的本地化字符串。
        /// </summary>
