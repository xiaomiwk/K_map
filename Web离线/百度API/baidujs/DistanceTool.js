...
(function() {
    ...
    var DistanceTool =
        ...
        BMapLib.DistanceTool = function(map, opts){
             ...
             */
             this._styles = {
                 "BMapLib_diso" : "height:17px;width:5px;position:absolute;background:url(../baiduimages/dis_box_01.gif) no-repeat left top"
                 ,"BMapLib_disi" : "color:#7a7a7a;position:absolute;left:5px;padding:0 4px 1px 0;line-height:17px;background:url(../baiduimages/dis_box_01.gif) no-repeat right top" 
    ...
    DistanceTool.prototype._addSecPoint = function(pt){
        var ico = 
            this._opts.secIcon ? 
                this._opts.secIcon :
                new BMap.Icon("../baiduimages/mapctrls.png", new BMap.Size(11, 11), {imageOffset: new BMap.Size(-26, -313)});
    ...
    DistanceTool.prototype._processLastOp = function() {
        ...
        var bico = 
            this._opts.closeIcon ? 
                this._opts.closeIcon :
                new BMap.Icon("../baiduimages/mapctrls.gif", new BMap.Size(12, 12), {imageOffset: new BMap.Size(0, -14)});
    ...
    var OperationMask = {
         ...
         * @type {String}
         */
        _html : "<div style='background:transparent url(../baiduimages/blank.gif);position:absolute;left:0;top:0;width:100%;height:100%;z-index:1000' unselectable='on'></div>",
