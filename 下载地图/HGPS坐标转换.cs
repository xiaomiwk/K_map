...
namespace 下载地图
{
    public static class HGPS坐标转换
    {
        ...
        public static PointLatLng 百度坐标转谷歌坐标(PointLatLng bd)
        {
    ...
    public class PositionUtil
    {
        ...
        public static PointLatLng bd09_To_Gps84(double bd_lat, double bd_lon)
        {
            ...
            PointLatLng gcj02 = PositionUtil.bd09_To_Gcj02(bd_lat, bd_lon);
            PointLatLng map84 = PositionUtil.gcj_To_Gps84(gcj02.Lat,
                    gcj02.Lng);
            return map84;
